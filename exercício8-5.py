...
print(codecs.encode('fernando', 'rot13'))
print(codecs.encode('valeria', 'rot13'))
print(codecs.encode('luiza', 'rot13'))
print(codecs.encode('henrique', 'rot13'))
print(codecs.encode('souza', 'rot13'))
print(codecs.encode('link', 'rot13'))
